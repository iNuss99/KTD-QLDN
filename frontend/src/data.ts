...
export const INITIAL_EMPLOYEES: Employee[] = [
  {
    ...
    firstName: 'Sarah',
    lastName: 'Jenkins',
    email: 's.jenkins@techretail.com',
    role: 'Store Manager',
  ...
  },
  {
    ...
    firstName: 'Elena',
    lastName: 'Rodriguez',
    email: 'e.rodriguez@techretail.com',
  ...
  },
  {
    ...
    firstName: 'Thomas',
    lastName: 'Anderson',
    email: 't.anderson@techretail.com',
