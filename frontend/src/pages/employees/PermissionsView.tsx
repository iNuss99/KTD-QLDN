...
import { Shield, Filter, Search, RotateCcw, Save, Check, AlertTriangle, X } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-5 text-sm text-slate-600">
              <p>Bạn có chắc chắn muốn khôi phục toàn bộ phân quyền về mặc định hệ thống không?</p>
              <p className="mt-2 text-amber-600 font-medium text-xs">Lưu ý: Mọi thay đổi chưa lưu sẽ bị mất.</p>
            </div>
