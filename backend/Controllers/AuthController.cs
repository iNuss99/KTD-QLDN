...
namespace techretail_api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var genericResponse = new { message = "Nếu email tồn tại trong hệ thống, hướng dẫn đặt lại mật khẩu sẽ được gửi đến." };
            ...
            var newPassword = await _userService.ResetPasswordAsync(user.Id);
            if (newPassword == null)
            {
                // Return generic response even on internal failure to avoid enumeration
                return Ok(genericResponse);
            }

            // In a real application, you would send an email here.
            // Since this is a demo, we return it in the API for the frontend to show a mock email.
            return Ok(new
            {
